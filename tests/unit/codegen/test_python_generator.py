...
class TestPythonCodeGenerator:
    ...
    def test_generate_string_literal(self, generator):
        ...
        program = Program(
            [AssignmentStatement(target=Identifier("name"), value=StringLiteral("hello"))]
        )
    ...
    def test_generate_boolean_literal(self, generator):
        ...
        program = Program(
            [AssignmentStatement(target=Identifier("flag"), value=BooleanLiteral(True))]
        )
    ...
    def test_generate_object_literal(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("obj"), value=ObjectLiteral({"key": StringLiteral("value")})
                )
            ]
        )
    ...
    def test_generate_function_call(self, generator):
        ...
        program = Program([ExpressionStatement(FunctionCall("print", [StringLiteral("hello")]))])

        code, _ = generator.generate(program)

        assert "_safe_call" in code
        assert "builtin.print" in code
    ...
    def test_generate_while_loop(self, generator):
        ...
        program = Program(
            [
                WhileStatement(
                    condition=BooleanLiteral(True), body=BlockStatement([BreakStatement()])
                )
            ]
        )
    ...
    def test_generate_for_loop(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("items"), ArrayLiteral([NumberLiteral(1), NumberLiteral(2)])),
                ForStatement(
    ...
    def test_generate_unary_expression(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("neg"), value=UnaryExpression("-", NumberLiteral(5))
                )
            ]
        )
                    ...
                    body=[
                        IfStatement(
                            ...
                            then_statement=BlockStatement(
                                [
                                    ExpressionStatement(
                                        FunctionCall("print", [StringLiteral("nested")])
                                    )
                                ]
                            ),
                        )
    ...
    def test_safe_identifier_conversion(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("class"), value=NumberLiteral(42)  # Python keyword
                )
            ]
        )
    ...
    def test_return_statement(self, generator):
        ...
        program = Program(
            [
                FunctionDefinition(
                    name="getValue", parameters=[], body=[ReturnStatement(NumberLiteral(42))]
                )
            ]
        )
    ...
    def test_continue_statement(self, generator):
        ...
        program = Program(
            [
                WhileStatement(
                    condition=BooleanLiteral(True), body=BlockStatement([ContinueStatement()])
                )
            ]
        )
...
class TestVisitorMethods:
    ...
    def test_visit_try_except(self, generator):
        ...
        from mlpy.ml.grammar.ast_nodes import ExceptClause, TryStatement
    ...
    def test_visit_import_statement(self, generator):
        ...
        program = Program([ImportStatement(target=["os"], alias="operating_system")])
    ...
    def test_visit_capability_declaration(self, generator):
        ...
        program = Program(
            [CapabilityDeclaration(name="file_cap", items=[ResourcePattern("*.txt")])]
        )
    ...
    def test_visit_array_access(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("arr"), ArrayLiteral([NumberLiteral(1), NumberLiteral(2)])),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=ArrayAccess(array=Identifier("arr"), index=NumberLiteral(0)),
                )
            ]
        )
    ...
    def test_visit_member_access(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("obj"), ObjectLiteral({"property": NumberLiteral(42)})),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=MemberAccess(object=Identifier("obj"), member="property"),
                )
            ]
        )
    ...
    def test_visit_throw_statement(self, generator):
        ...
        program = Program(
            [ThrowStatement(error_data=ObjectLiteral({"message": StringLiteral("error")}))]
        )
    ...
    def test_empty_array_literal(self, generator):
        ...
        program = Program([AssignmentStatement(target=Identifier("empty"), value=ArrayLiteral([]))])
    ...
    def test_function_with_no_params(self, generator):
        ...
        program = Program(
            [
                FunctionDefinition(
                    name="noParams", parameters=[], body=[ReturnStatement(NumberLiteral(42))]
                )
            ]
        )
                ...
                IfStatement(
                    ...
                    elif_clauses=[
                        ElifClause(
                            condition=BooleanLiteral(False),
                            statement=BlockStatement(
                                [ExpressionStatement(FunctionCall("print", [NumberLiteral(2)]))]
                            ),
                        ),
                        ElifClause(
                            condition=BooleanLiteral(True),
                            statement=BlockStatement(
                                [ExpressionStatement(FunctionCall("print", [NumberLiteral(3)]))]
                            ),
                        ),
                    ],
                )
...
class TestAdvancedExpressions:
    ...
    def test_not_operator(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("result"), value=UnaryExpression("not", BooleanLiteral(True))
                )
            ]
        )
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("result"),
                    value=BinaryExpression(
                        BinaryExpression(NumberLiteral(10), "+", NumberLiteral(5)),
                        "*",
                        BinaryExpression(NumberLiteral(3), "-", NumberLiteral(1)),
                    ),
                )
            ]
        )
...
class TestImportStatements:
    ...
    def test_simple_import(self, generator):
        ...
        program = Program([ImportStatement(target=["math"], alias=None)])
    ...
    def test_import_with_alias(self, generator):
        ...
        program = Program([ImportStatement(target=["datetime"], alias="dt")])
    ...
    def test_nested_module_import(self, generator):
        ...
        program = Program([ImportStatement(target=["os", "path"], alias=None)])
...
class TestExceptionHandling:
    ...
    def test_try_without_except(self, generator):
        ...
        program = Program(
            [
                TryStatement(
                    try_body=[ExpressionStatement(FunctionCall("risky", []))], except_clauses=[]
                )
            ]
        )
                ...
                TryStatement(
                    ...
                    except_clauses=[
                        ExceptClause(
                            ...
                            body=[
                                ExpressionStatement(
                                    FunctionCall("print", [StringLiteral("value error")])
                                )
                            ],
                        ),
                        ExceptClause(
                            ...
                            body=[
                                ExpressionStatement(
                                    FunctionCall("print", [StringLiteral("type error")])
                                )
                            ],
                        ),
                    ],
                ...
                TryStatement(
                    ...
                    except_clauses=[
                        ExceptClause(
                            ...
                            body=[
                                ExpressionStatement(FunctionCall("print", [StringLiteral("error")]))
                            ],
                        )
                    ],
                )
...
class TestCodeGeneratorIntegration:
    ...
    def test_nested_control_flow(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("items"), ArrayLiteral([NumberLiteral(1), NumberLiteral(10)])),
                WhileStatement(
                    condition=BooleanLiteral(True),
                    body=BlockStatement(
                        [
...
class TestObjectLiterals:
    ...
    def test_empty_object_literal(self, generator):
        ...
        program = Program([AssignmentStatement(target=Identifier("obj"), value=ObjectLiteral({}))])
        ...
        program = Program(
            [
                AssignmentStatement(
                    ...
                    value=ObjectLiteral({"user": ObjectLiteral({"name": StringLiteral("Bob")})}),
                )
            ]
        )
...
class TestFunctionCalls:
    ...
    def test_function_call_no_args(self, generator):
        ...
        program = Program([ExpressionStatement(FunctionCall("getData", []))])
    ...
    def test_nested_function_calls(self, generator):
        ...
        program = Program(
            [
                ExpressionStatement(
                    FunctionCall("outer", [FunctionCall("inner", [NumberLiteral(42)])])
                )
            ]
        )
    ...
    def test_nested_member_access(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    Identifier("obj"),
                    ObjectLiteral({"nested": ObjectLiteral({"prop": NumberLiteral(42)})})
                ),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=MemberAccess(
                        object=MemberAccess(object=Identifier("obj"), member="nested"),
                        member="prop",
                    ),
                )
            ]
    ...
    def test_array_access_with_expression(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    Identifier("arr"),
                    ArrayLiteral([NumberLiteral(i) for i in range(10)])
                ),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=ArrayAccess(
    ...
    def test_chained_array_access(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    Identifier("matrix"),
                    ArrayLiteral([ArrayLiteral([NumberLiteral(1), NumberLiteral(2)])])
                ),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=ArrayAccess(
                        array=ArrayAccess(array=Identifier("matrix"), index=NumberLiteral(0)),
...
class TestEdgeCases:
    ...
    def test_very_long_identifier(self, generator):
        ...
        program = Program(
            [AssignmentStatement(target=Identifier(long_name), value=NumberLiteral(42))]
        )
    ...
    def test_special_characters_in_string(self, generator):
        ...
        program = Program(
            [AssignmentStatement(target=Identifier("text"), value=StringLiteral("Hello\nWorld\t!"))]
        )
            ...
            [
                AssignmentStatement(
                    ...
                    value=FunctionDefinition(
                        ...
                        body=[
                            ReturnStatement(
                                BinaryExpression(Identifier("x"), "*", NumberLiteral(2))
                            )
                        ],
                    ),
                )
...
class TestSourceMapGeneration:
    ...
    def test_source_map_disabled_by_default(self):
        ...
        generator = PythonCodeGenerator(generate_source_maps=False)
        program = Program([AssignmentStatement(target=Identifier("x"), value=NumberLiteral(1))])
...
class TestComplexOperatorMappings:
    ...
    def test_in_operator(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("arr"), ArrayLiteral([NumberLiteral(1), NumberLiteral(5)])),
                AssignmentStatement(
                    target=Identifier("result"),
    ...
    def test_is_operator(self, generator):
        ...
        program = Program(
            [
                ...
                AssignmentStatement(Identifier("y"), NumberLiteral(42)),
                AssignmentStatement(
                    target=Identifier("result"),
...
class TestAssignmentVariations:
    ...
    def test_array_element_assignment(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("arr"), ArrayLiteral([NumberLiteral(0)])),
                AssignmentStatement(
                    target=ArrayAccess(array=Identifier("arr"), index=NumberLiteral(0)),
    ...
    def test_object_property_assignment(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("obj"), ObjectLiteral({"prop": NumberLiteral(0)})),
                AssignmentStatement(
                    target=MemberAccess(object=Identifier("obj"), member="prop"),
                    value=NumberLiteral(42),
                )
            ]
        )
    ...
    def test_chained_assignment_target(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    Identifier("obj"),
                    ObjectLiteral({"nested": ObjectLiteral({"value": NumberLiteral(0)})})
                ),
                AssignmentStatement(
                    target=MemberAccess(
                        object=MemberAccess(object=Identifier("obj"), member="nested"),
...
class TestIdentifierSafety:
    ...
    def test_python_keyword_conversion(self, generator):
        ...
        for keyword in keywords:
            program = Program(
                [AssignmentStatement(target=Identifier(keyword), value=NumberLiteral(42))]
            )
    ...
    def test_builtin_function_names(self, generator):
        ...
        for builtin in builtins:
            program = Program(
                [AssignmentStatement(target=Identifier(builtin), value=NumberLiteral(42))]
            )
...
class TestUtilityFunction:
    ...
    def test_generate_with_source_file(self):
        ...
        program = Program([AssignmentStatement(target=Identifier("y"), value=NumberLiteral(100))])

        code, source_map = generate_python_code(
            program, source_file="test.ml", generate_source_maps=True
        )
...
class TestBlockStatements:
    ...
    def test_empty_block_statement(self, generator):
        ...
        program = Program(
            [IfStatement(condition=BooleanLiteral(True), then_statement=BlockStatement([]))]
        )
...
class TestExpressionStatements:
    ...
    def test_standalone_expression(self, generator):
        ...
        program = Program(
            [ExpressionStatement(BinaryExpression(NumberLiteral(1), "+", NumberLiteral(2)))]
        )
    ...
    def test_function_call_expression_statement(self, generator):
        ...
        program = Program([ExpressionStatement(FunctionCall("doSomething", []))])
...
class TestComplexPrograms:
    ...
    def test_mixed_control_flow(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(target=Identifier("count"), value=NumberLiteral(0)),
                WhileStatement(
                    ...
                    body=BlockStatement(
                        [
                            IfStatement(
                                condition=BinaryExpression(
                                    Identifier("count"), "%", NumberLiteral(2)
                                ),
                                then_statement=BlockStatement(
                                    [
                                        AssignmentStatement(
                                            ...
                                            value=BinaryExpression(
                                                Identifier("count"), "+", NumberLiteral(1)
                                            ),
                                        ),
                                        ContinueStatement(),
                                    ]
...
class TestUnaryExpressions:
    ...
    def test_negation_operator(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("neg"), value=UnaryExpression("-", NumberLiteral(10))
                )
            ]
        )
    ...
    def test_bitwise_not_operator(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("inverted"), value=UnaryExpression("~", NumberLiteral(5))
                )
            ]
        )
...
class TestMLLanguageLiterals:
    """Test ML language literals like null and undefined."""
    ...
    def test_null_literal(self, generator):
        """Test null literal translates to None."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("null"))]
        )
    ...
    def test_undefined_literal(self, generator):
        """Test undefined literal translates to None."""
        program = Program(
            [AssignmentStatement(target=Identifier("y"), value=Identifier("undefined"))]
        )
...
class TestREPLModeSecurityChecks:
    """Test REPL mode security features."""

    @pytest.fixture
    def repl_generator(self):
        """Create REPL mode generator."""
        return PythonCodeGenerator(repl_mode=True)

    def test_repl_mode_allows_unknown_variables(self, repl_generator):
        """Test REPL mode allows unknown variables (runtime check)."""
        program = Program(
            [AssignmentStatement(target=Identifier("result"), value=Identifier("someVar"))]
        )

        code, _ = repl_generator.generate(program)

        # Should not raise ValueError - REPL mode allows unknown identifiers
        assert "someVar" in code

    def test_repl_mode_blocks_builtins_access(self, repl_generator):
        """Test REPL mode blocks __builtins__ access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("__builtins__"))]
        )

        with pytest.raises(ValueError, match="Security.*__builtins__"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_import_access(self, repl_generator):
        """Test REPL mode blocks __import__ access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("__import__"))]
        )

        with pytest.raises(ValueError, match="Security.*__import__"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_eval(self, repl_generator):
        """Test REPL mode blocks eval access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("eval"))]
        )

        with pytest.raises(ValueError, match="Security.*eval"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_exec(self, repl_generator):
        """Test REPL mode blocks exec access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("exec"))]
        )

        with pytest.raises(ValueError, match="Security.*exec"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_globals(self, repl_generator):
        """Test REPL mode blocks globals access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("globals"))]
        )

        with pytest.raises(ValueError, match="Security.*globals"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_locals(self, repl_generator):
        """Test REPL mode blocks locals access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("locals"))]
        )

        with pytest.raises(ValueError, match="Security.*locals"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_dict_access(self, repl_generator):
        """Test REPL mode blocks __dict__ access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("__dict__"))]
        )

        with pytest.raises(ValueError, match="Security.*__dict__"):
            repl_generator.generate(program)

    def test_repl_mode_blocks_class_access(self, repl_generator):
        """Test REPL mode blocks __class__ access."""
        program = Program(
            [AssignmentStatement(target=Identifier("x"), value=Identifier("__class__"))]
        )

        with pytest.raises(ValueError, match="Security.*__class__"):
            repl_generator.generate(program)




class TestMLBuiltinFunctionUsage:
    """Test ML builtin functions are properly routed."""
    ...
    def test_ml_builtin_routes_to_builtin_module(self, generator):
        """Test ML builtins route to builtin module."""
        # len is an ML builtin
        program = Program(
            [
                AssignmentStatement(
                    target=Identifier("size"),
                    value=FunctionCall("len", [ArrayLiteral([NumberLiteral(1), NumberLiteral(2)])]),
                )
            ]
        )
        ...
        # Should route through builtin module
        assert "builtin.len" in code or "_safe_call" in code


class TestExpressionEdgeCases:
    """Test edge cases in expression generation."""
    ...
    def test_nested_binary_expressions(self, generator):
        ...
        program = Program(
            [
                AssignmentStatement(Identifier("a"), NumberLiteral(1)),
                AssignmentStatement(Identifier("b"), NumberLiteral(2)),
                AssignmentStatement(Identifier("c"), NumberLiteral(3)),
                AssignmentStatement(Identifier("d"), NumberLiteral(4)),
                AssignmentStatement(Identifier("e"), NumberLiteral(5)),
                AssignmentStatement(
                    target=Identifier("result"),
                    value=BinaryExpression(
                        left=BinaryExpression(
                            left=BinaryExpression(Identifier("a"), "+", Identifier("b")),
                            operator="*",
                            right=BinaryExpression(Identifier("c"), "-", Identifier("d")),
                        ),
                        operator="/",
                        right=Identifier("e"),
                    ),
        ...
        # Should generate valid nested expression
        assert "+" in code and "*" in code and "-" in code and "/" in code

    def test_chained_member_access(self, generator):
        """Test chained member access a.b.c."""
        program = Program(
            [
                AssignmentStatement(Identifier("obj"), ObjectLiteral({})),
                AssignmentStatement(
                    target=Identifier("value"),
                    value=MemberAccess(MemberAccess(Identifier("obj"), "inner"), "prop"),
                ),
            ]
        )
    ...
    def test_single_element_array(self, generator):
        """Test single element array."""
        program = Program(
            [AssignmentStatement(target=Identifier("single"), value=ArrayLiteral([NumberLiteral(42)]))]
        )
    ...
    def test_empty_object_literal(self, generator):
        """Test empty object literal."""
        program = Program([AssignmentStatement(target=Identifier("empty"), value=ObjectLiteral({}))])
...
class TestControlFlowEdgeCases:
    """Test edge cases in control flow generation."""
    ...
    def test_while_with_break(self, generator):
    ...
    def test_for_with_continue(self, generator):
        """Test for loop with continue statement."""
        program = Program(
            [
                AssignmentStatement(Identifier("items"), ArrayLiteral([NumberLiteral(1)])),
                ForStatement(
    ...
    def test_if_without_else(self, generator):
        """Test if statement without else branch."""
        program = Program(
            [
                IfStatement(
                    condition=BooleanLiteral(True),
                    then_statement=BlockStatement([ExpressionStatement(NumberLiteral(1))]),
                    else_statement=None,
                )
            ]
        )
    ...
    def test_nested_if_statements(self, generator):
...
class TestFunctionDefinitionEdgeCases:
    ...
    def test_function_with_no_parameters(self, generator):
        """Test function with no parameters."""
        program = Program(
            [
                FunctionDefinition(
                    name="noArgs", parameters=[], body=[ReturnStatement(NumberLiteral(42))]
                )
            ]
        )
        ...
        assert "def noArgs()" in code

    def test_function_with_multiple_parameters(self, generator):
        """Test function with multiple parameters."""
        program = Program(
            [
                FunctionDefinition(
                    name="multiParam",
                    parameters=[Parameter("a"), Parameter("b"), Parameter("c")],
                    body=[ReturnStatement(Identifier("a"))],
                )
            ]
        )
        ...
        assert "def multiParam(a, b, c)" in code

    def test_function_with_no_return(self, generator):
        ...
        program = Program(
            [
                FunctionDefinition(
                    name="noReturn",
                    parameters=[],
                    body=[ExpressionStatement(NumberLiteral(1))],
                )
            ]
        )
        ...
        assert "def noReturn()" in code

    def test_function_with_multiple_statements(self, generator):
            ...
            [
                FunctionDefinition(
                    ...
                    body=[
                        ...
                        ReturnStatement(BinaryExpression(Identifier("x"), "+", Identifier("y"))),
                    ],
                )
            ]
        )
        ...
        assert "def multiStatement()" in code
        assert "return" in code
