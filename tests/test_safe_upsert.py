...
def main():
    ...
    print("Update pos 2: " + str(str(result1) + ""))
    arr2 = [10, 20, 30]
    result2 = safe_upsert(arr2, 0, 100)
    print("Update pos 0: " + str(str(result2) + ""))
    arr3 = [1, 2, 3]
    result3 = safe_upsert(arr3, 2, 300)
    print("Update last pos: " + str(str(result3) + ""))
    arr4 = [1, 2, 3]
    result4 = safe_upsert(arr4, 3, 4)
    print("Append at length: " + str(str(result4) + ""))
    result5 = safe_upsert(arr4, 5, 6)
    print("Append beyond length: " + str(str(result5) + ""))
    arr6 = [1, 2, 3]
    result6 = safe_append(arr6, 4)
    print("Safe append: " + str(str(result6) + ""))
    start = [1, 2, 3]
    step1 = safe_upsert(start, 1, 20)
    step2 = safe_upsert(step1, 3, 4)
    step3 = safe_upsert(step2, 0, 10)
    print("Chained upserts: " + str(str(step3) + ""))
    print("=== Test Complete ===")
