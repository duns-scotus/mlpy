...
def basic_arithmetic_operations():
    ...
    division = (a / b)
    modulo = (a % b)
    print((str((str((str((str('Basic arithmetic with a=') + str(a))) + str(', b='))) + str(b))) + str(':')))
    print((str((str((str((str((str('Addition: ') + str(a))) + str(' + '))) + str(b))) + str(' = '))) + str(addition)))
    print((str((str((str((str((str('Subtraction: ') + str(a))) + str(' - '))) + str(b))) + str(' = '))) + str(subtraction)))
    print((str((str((str((str((str('Multiplication: ') + str(a))) + str(' * '))) + str(b))) + str(' = '))) + str(multiplication)))
    print((str((str((str((str((str('Division: ') + str(a))) + str(' / '))) + str(b))) + str(' = '))) + str(division)))
    print((str((str((str((str((str('Modulo: ') + str(a))) + str(' % '))) + str(b))) + str(' = '))) + str(modulo)))
    expr1 = (a + (b * c))
    expr2 = ((a + b) * c)
    expr3 = ((a / b) + c)
    expr4 = (a / (b + c))
    ...
    print((str('15 + 4 * 2 = ') + str(expr1)))
    print((str('(15 + 4) * 2 = ') + str(expr2)))
    print((str('15 / 4 + 2 = ') + str(expr3)))
    print((str('15 / (4 + 2) = ') + str(expr4)))
    print((str('15 + 4 - 2 * 2 = ') + str(expr5)))
    print((str('15 * 4 % 2 + 1 = ') + str(expr6)))
    positive = a
    negative = a
    double_negative = a
    print('\\nUnary operations:')
    print((str((str((str('Positive: +') + str(a))) + str(' = '))) + str(positive)))
    print((str((str((str('Negative: -') + str(a))) + str(' = '))) + str(negative)))
    print((str((str((str('Double negative: -(-') + str(a))) + str(') = '))) + str(double_negative)))
    return {'basic': {'addition': addition, 'subtraction': subtraction, 'multiplication': multiplication, 'division': division, 'modulo': modulo}, 'precedence': [expr1, expr2, expr3, expr4, expr5, expr6], 'unary': {'positive': positive, 'negative': negative, 'double_negative': double_negative}}
...
def advanced_mathematical_functions():
    ...
    print((str('2^3 = ') + str(pow_results[0])))
    print((str('5^2 = ') + str(pow_results[1])))
    print((str('3^4 = ') + str(pow_results[2])))
    print((str('10^0 = ') + str(pow_results[3])))
    print((str('7^1 = ') + str(pow_results[4])))
    sqrt_results = []
    ...
    print((str('sqrt(25) = ') + str(sqrt_results[0])))
    print((str('sqrt(16) = ') + str(sqrt_results[1])))
    print((str('sqrt(2) = ') + str(sqrt_results[2])))
    print((str('sqrt(10) = ') + str(sqrt_results[3])))
    print((str('sqrt(0) = ') + str(sqrt_results[4])))
    ...
    while (j < test_numbers['length']()):
        print((str((str((str('abs(') + str(test_numbers[j]))) + str(') = '))) + str(abs_results[j])))
        j = (j + 1)
    min_result = min(15, 23)
    max_result = max(15, 23)
    print('\\nMin/Max operations:')
    print((str('min(15, 23) = ') + str(min_result)))
    print((str('max(15, 23) = ') + str(max_result)))
    return {'power_results': pow_results, 'sqrt_results': sqrt_results, 'abs_results': abs_results, 'min_max': {'min': min_result, 'max': max_result}}
...
def trigonometric_approximations():
    ...
    while (k < angles['length']()):
        ...
        print((str('Angle: ') + str(name)))
        print((str('  sin = ') + str(sin_val)))
        print((str('  cos = ') + str(cos_val)))
        print((str('  tan = ') + str(tan_val)))
        k = (k + 1)
    return {'constants': {'pi': PI, 'e': E}, 'test_angles': angles, 'results': 'trigonometric_calculations_completed'}
...
def statistical_analytical_functions():
    ...
    while (m < datasets['length']()):
        ...
        print((str('  Mean: ') + str(mean_val)))
        print((str('  Median: ') + str(median_val)))
        print((str('  Mode: ') + str(mode_val)))
        print((str('  Standard Deviation: ') + str(std_dev)))
        m = (m + 1)
...
def number_theory_discrete_math():
    ...
    while (n < test_primes['length']()):
        ...
        print((str((str((str('  ') + str(num))) + str(' is '))) + str('prime' if prime_result else 'not prime')))
        n = (n + 1)
    print('\\nPrime factorization:')
    ...
    while (o < factor_numbers['length']()):
        ...
        print((str((str((str('  ') + str(num))) + str(' = '))) + str(factors)))
        o = (o + 1)
    ...
    while (p < number_pairs['length']()):
        ...
        gcd_result = gcd(a, b)
        lcm_result = lcm(a, b)
        print((str((str((str((str((str((str((str((str((str((str((str('  GCD(') + str(a))) + str(', '))) + str(b))) + str(') = '))) + str(gcd_result))) + str(', LCM('))) + str(a))) + str(', '))) + str(b))) + str(') = '))) + str(lcm_result)))
        p = (p + 1)
    print('\\nFibonacci sequence (first 15 numbers):')
    fib_seq = fibonacci_sequence(15)
    print((str('  ') + str(fib_seq)))
    print('\\nCollatz sequences:')
    ...
    while (q < collatz_starts['length']()):
        ...
        print((str((str((str((str((str('  Starting with ') + str(start))) + str(' ('))) + str(collatz_seq['length']()))) + str(' steps): '))) + str(collatz_seq)))
        q = (q + 1)
    return {'primes_tested': test_primes, 'factorizations': factor_numbers, 'fibonacci': fib_seq, 'collatz_examples': collatz_starts}
...
def complex_mathematical_algorithms():
    ...
    def matrix_determinant_2x2(matrix):
        if ((matrix['length']() != 2) or (matrix[0]['length']() != 2)):
            return 0
    ...
    print((str('  A × B = ') + str(matrix_result)))
    det_A = matrix_determinant_2x2(matrix_A)
    det_B = matrix_determinant_2x2(matrix_B)
    print((str('  det(A) = ') + str(det_A)))
    print((str('  det(B) = ') + str(det_B)))
    ...
    while (r < test_x_values['length']()):
        ...
        print((str((str((str('  P(') + str(x_val))) + str(') = '))) + str(poly_result)))
        r = (r + 1)
    ...
    print((str((str('  Approximate integral = ') + str(integral_result))) + str(' (exact = 2.667)')))
    print('\\nNewton-Raphson method (finding sqrt(2)):')
    nr_result = newton_raphson(1.0, 1e-06, 50)
    print((str('  Root found: ') + str(nr_result['root'])))
    print((str('  Iterations: ') + str(nr_result['iterations'])))
    print((str('  Converged: ') + str(nr_result['converged'])))
    return {'matrix_ops': matrix_result, 'polynomial_test': 'completed', 'integration_result': integral_result, 'newton_raphson': nr_result}
